...
可直接在仓库的 [Releases](https://github.com/enshuwu46-png/ancient-ocr-macos/releases) 页面下载 `温古茶-v1.0.0-macOS-arm64.zip`。解压后将“温古茶.app”拖入“应用程序”；如果 macOS 首次拦截未公证的本地签名版本，请在 Finder 中右键 App 并选择“打开”。
